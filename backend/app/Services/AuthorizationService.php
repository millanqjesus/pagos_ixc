...
{
    /**
     * Consulta al servicio autorizador externo.
     *
     * @param  array  $payload  Datos a enviar al autorizador (from, to, amount, ...)
     * @return bool  true si autorizado, false en caso contrario
     */
    public function authorize(array $payload = []): bool
    {
        $url = env('AUTHORIZER_URL', 'https://66ad1f3cb18f3614e3b478f5.mockapi.io/v1').'/auth';
