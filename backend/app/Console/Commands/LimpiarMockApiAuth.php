...
class LimpiarMockApiAuth extends Command
{
    protected $signature = 'mockapiauth:limpiar';
    protected $description = 'Elimina todos los registros del recurso / auth en MockAPI';

    public function handle()
    {
        $baseUrl = 'https://66ad1f3cb18f3614e3b478f5.mockapi.io/v1/auth';

        $this->info('Obteniendo registros de MockAPI/auth...');
